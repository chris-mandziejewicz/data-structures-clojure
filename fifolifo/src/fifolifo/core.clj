...
(defn pop
  ...
  [stk]
  (cond (or (= (:size stk) 1) (= (:size stk) 0)) (Stack. nil 0)
...
(defn dequeue
  ...
  [queue]
  (cond (and (or (= (:size queue) 1) (= (:size queue) 0)) (empty? (:front queue))) (Queue. nil nil 0)
        (and (empty? (:front queue)) (> (:size queue) 1)) (Queue. nil (rest (reverse (:back queue))) (dec (:size queue)))
